# -*- coding: utf-8 -*-
"""
Created on Wed May 27 23:20:15 2020
...
def generate_projection(data,labels,filter_bank,time_windows,no_classes=4, m = 3):
...
def csp_one_one(cov_matrix, no_channels, m, no_classes = 4):
	'''	
...
def extract_feature(data,w,filter_bank,time_windows):
    ...
    Retrn:	features, numpy array of size [NO_trials,(NO_csp*NO_bands*NO_time_windows)] 
    '''
    no_csp = len(w[0,0,0,:])
